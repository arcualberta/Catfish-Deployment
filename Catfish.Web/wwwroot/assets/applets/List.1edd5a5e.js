...
import { _ as U, u as w, e as j } from "./library-exports.3a0eaa78.js";
...
const K = /* @__PURE__ */ U(J, [["__scopeId", "data-v-d7d9691d"]]), O = { class: "row entryRow" }, Q = { class: "col-sm-3" }, W = /* @__PURE__ */ g({
  ...
  setup(p) {
    const e = p, l = $(!1), a = $(!1), _ = w(), r = S(() => _.apiRoot), b = S(() => j);
    console.log("stateList", b);
    const E = () => l.value = !l.value, h = () => a.value = !a.value, P = (k, t, m) => {
      _.changeStatus(k, t, m), l.value = !l.value, _.loadEntries(r == null ? void 0 : r.value);
...
const X = /* @__PURE__ */ U(W, [["__scopeId", "data-v-c40be1df"]]), te = /* @__PURE__ */ g({
  __name: "List",
  setup(p) {
    const e = w(), { entries: l } = F(e);
    return (a, _) => (n(), c(v, null, [
      o("h4", null, [
        i("List "),
        u(a.$slots, "object-type"),
        i("s")
      ]),
      (n(!0), c(v, null, T(f(l), (r) => (n(), c("div", {
        key: r.id.toString()
      }, [
