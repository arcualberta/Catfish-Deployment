...
import { _ as S, u as w } from "./library-exports.b5818a91.js";
...
const h = /* @__PURE__ */ S(O, [["__scopeId", "data-v-1c174a09"]]), q = { class: "row entryRow" }, z = /* @__PURE__ */ y({
  ...
  setup(d) {
    const o = d, n = k(!1), r = k(!1), v = w(), u = () => n.value = !n.value, b = () => r.value = !r.value, f = (g) => {
        ...
        r.value ? (a(), m(h, {
          ...
          footer: s(() => [
            t("button", {
              ...
              onClick: e[2] || (e[2] = (i) => f("https://localhost:5020/api/items/" + o.entry.id)),
        ...
        n.value ? (a(), m(h, {
          ...
          footer: s(() => [
            t("button", {
              ...
              onClick: e[6] || (e[6] = (i) => f("https://localhost:5020/api/items/" + o.entry.id)),
              "aria-label": "Close modal"
            }, " Delete "),
            t("button", {
              type: "button",
...
const A = /* @__PURE__ */ S(z, [["__scopeId", "data-v-34ebeb2d"]]), K = /* @__PURE__ */ y({
  __name: "List",
  setup(d) {
