...
const D = /* @__PURE__ */ U(G, [["__scopeId", "data-v-5b6b18b4"]]), H = { class: "row entryRow" }, J = { class: "col-sm-3" }, K = { class: "form-select" }, Q = /* @__PURE__ */ f({
  ...
  setup(u) {
    ...
    const C = () => n.value = !n.value, k = () => d.value = !d.value, $ = (T) => {
      m.deleteObject(T), n.value = !n.value, m.loadEntries(r == null ? void 0 : r.value);
      ...
      return a(), p("div", H, [
        ...
        d.value ? (a(), _(D, {
          ...
          body: l(() => [
            ...
            e("div", J, [
              e("select", K, [
                (a(), p(v, null, E(g, (s) => e("option", null, w(s), 1)), 64))
              ])
            ])
          ]),
          footer: l(() => [
            e("button", {
              ...
              onClick: t[2] || (t[2] = (s) => $(b(r) + o.entry.id)),
        ...
        n.value ? (a(), _(D, {
          ...
          footer: l(() => [
            e("button", {
              ...
              onClick: t[6] || (t[6] = (s) => $(b(r) + "/" + o.entry.id)),
              "aria-label": "Close modal"
            }, " Delete "),
            e("button", {
              type: "button",
...
const W = /* @__PURE__ */ U(Q, [["__scopeId", "data-v-37f163e8"]]), ee = /* @__PURE__ */ f({
  __name: "List",
  setup(u) {
    const o = x(), { entries: n } = F(o);
    return (d, m) => (a(), p(v, null, [
      e("h4", null, [
        i("List "),
        c(d.$slots, "object-type"),
        i("s")
      ]),
      (a(!0), p(v, null, E(b(n), (r) => (a(), p("div", {
        key: r.id.toString()
      }, [
