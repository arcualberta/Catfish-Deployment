...
import { _ as L, u as U, e as I } from "./library-exports.2c48e1ae.js";
...
const w = /* @__PURE__ */ L(z, [["__scopeId", "data-v-5b6b18b4"]]), A = { class: "row entryRow" }, G = { class: "col-sm-3" }, H = { class: "form-select" }, J = /* @__PURE__ */ b({
  __name: "ListEntry",
  props: {
    entry: null
  },
  setup(d) {
    const o = d, n = h(!1), i = h(!1), v = U(), p = () => I, f = () => n.value = !n.value, g = () => i.value = !i.value, C = (k) => {
