...
import { _ as h, u as k } from "./library-exports.77466778.js";
...
const O = /* @__PURE__ */ h(M, [["__scopeId", "data-v-25885900"]]), q = (o) => (E("data-v-2c8c8fda"), o = o(), I(), o), z = { class: "row entryRow" }, A = /* @__PURE__ */ q(() => /* @__PURE__ */ t("a", {
  href: "#",
  class: "col-2"
  ...
  setup(o) {
    const e = o, s = w(!1), c = k(), u = () => s.value = !s.value, i = (y) => c.deleteObject(y), $ = "/read/" + e.entry.id, S = "/update/" + e.entry.id;
...
const H = /* @__PURE__ */ h(G, [["__scopeId", "data-v-2c8c8fda"]]), W = /* @__PURE__ */ m({
  __name: "List",
  setup(o) {
