...
import { _ as S, u as D } from "./library-exports.1c6e9ea9.js";
...
const h = /* @__PURE__ */ S(O, [["__scopeId", "data-v-1c174a09"]]), q = { class: "row entryRow" }, z = /* @__PURE__ */ y({
  ...
  setup(d) {
    const o = d, n = k(!1), r = k(!1), v = D(), u = () => n.value = !n.value, f = () => r.value = !r.value, b = (g) => {
      v.deleteObject(g), n.value = !n.value;
    }, w = "/read/" + o.entry.id, U = "/update/" + o.entry.id;
...
const A = /* @__PURE__ */ S(z, [["__scopeId", "data-v-75632a2e"]]), K = /* @__PURE__ */ y({
  __name: "List",
  setup(d) {
    const o = D(), { entries: n } = V(o);
