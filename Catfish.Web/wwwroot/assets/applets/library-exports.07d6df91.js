...
var Ga = /* @__PURE__ */ ((e) => (e.ShortAnswer = "ShortAnswer", e.Paragraph = "Paragraph", e.RichText = "Rich Text", e.AttachmentField = "AttachmentField", e))(Ga || {}), ss = /* @__PURE__ */ ((e) => (e.Date = "Date", e.DateTime = "DateTime", e.Decimal = "Decimal", e.Integer = "Integer", e.Email = "Email", e))(ss || {}), Jr = /* @__PURE__ */ ((e) => (e.Checkboxes = "Checkboxes", e.DataList = "DataList", e.RadioButtons = "RadioButtons", e.DropDown = "DropDown", e))(Jr || {}), fv = /* @__PURE__ */ ((e) => (e.InfoSection = "InfoSection", e))(fv || {}), Te = /* @__PURE__ */ ((e) => (e.ShortAnswer = "ShortAnswer", e.Paragraph = "Paragraph", e.RichText = "RichText", e.Date = "Date", e.DateTime = "DateTime", e.Decimal = "Decimal", e.Integer = "Integer", e.Email = "Email", e.Checkboxes = "Checkboxes", e.DataList = "DataList", e.RadioButtons = "RadioButtons", e.DropDown = "DropDown", e.InfoSection = "InfoSection", e.AttachmentField = "AttachmentField", e))(Te || {});
...
const Er = wn("FormBuilderStore", {
  ...
  actions: {
    ...
    saveForm() {
      ...
      e ? (console.log("Saving new form."), this.form.id = oe.create().toString(), n = "POST") : (console.log("Updating existing form."), t = `${t}/${this.form.id}`, n = "PUT", console.log("form ", JSON.stringify(this.form))), fetch(
        t,
        {
...
const oi = /* @__PURE__ */ Ut(mT, [["__scopeId", "data-v-685bad7e"]]), ZF = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
...
}, Symbol.toStringTag, { value: "Module" })), gT = [
  {
    path: "/",
    name: "List",
    component: () => import("./List.ac43c189.js")
  },
  {
    path: "/create",
    name: "Create",
    component: () => import("./Create.345bf3ea.js")
  },
  {
    path: "/read/:id",
    name: "Read",
    component: () => import("./Read.6a946848.js")
  },
  {
    path: "/update/:id",
    name: "Update",
    component: () => import("./Update.7a0f82cb.js")
  },
  {
    path: "/delete/:id",
    name: "Delete",
    component: () => import("./Delete.6e5750ac.js")
  }
], ks = yw({
  history: N1(),
  routes: gT
