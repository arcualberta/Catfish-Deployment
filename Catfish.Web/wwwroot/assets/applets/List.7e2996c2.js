import { defineComponent as g, openBlock as r, createBlock as _, Transition as B, withCtx as l, createElementVNode as e, renderSlot as c, createCommentVNode as v, ref as L, computed as N, resolveComponent as V, createElementBlock as p, createVNode as w, createTextVNode as a, toDisplayString as b, unref as m, Fragment as f, renderList as U, resolveDynamicComponent as I } from "vue";
import { _ as x, u as E, e as j } from "./library-exports.78175f41.js";
      ...
      return r(), p("div", H, [
        ...
        i.value ? (r(), _(D, {
          ...
          body: l(() => [
            ...
            e("div", J, [
              e("select", K, [
                (r(), p(f, null, U(C, (s) => e("option", null, b(s), 1)), 64))
              ])
            ])
          ]),
          footer: l(() => [
...
const W = /* @__PURE__ */ x(Q, [["__scopeId", "data-v-88e3d34d"]]), ee = /* @__PURE__ */ g({
  __name: "List",
  setup(u) {
    const o = E(), { entries: n } = F(o);
    return (i, y) => (r(), p(f, null, [
      e("h4", null, [
        a("List "),
        c(i.$slots, "object-type"),
        a("s")
      ]),
      (r(!0), p(f, null, U(m(n), (d) => (r(), p("div", {
        key: d.id.toString()
      }, [
