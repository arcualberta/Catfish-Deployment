...
const T = /* @__PURE__ */ S(O, [["__scopeId", "data-v-1c174a09"]]), q = { class: "row entryRow" }, z = /* @__PURE__ */ y({
  __name: "ListEntry",
  props: {
    entry: null
  },
  setup(d) {
    const o = d, n = k(!1), r = k(!1), v = w(), u = () => n.value = !n.value, f = () => r.value = !r.value, g = (b) => {
      v.deleteObject(b), n.value = !n.value;
    }, D = "/read/" + o.entry.id, U = "/update/" + o.entry.id;
    return "" + o.entry.id, "" + o.entry.id, (b, e) => {
        ...
        r.value ? (a(), m(T, {
          ...
          footer: s(() => [
            t("button", {
              ...
              onClick: e[2] || (e[2] = (i) => g("https://localhost:5020/api/items/" + o.entry.id)),
        ...
        n.value ? (a(), m(T, {
          ...
          footer: s(() => [
            t("button", {
              ...
              onClick: e[6] || (e[6] = (i) => g("https://localhost:5020/api/items/" + o.entry.id)),
              "aria-label": "Close modal"
            }, " Delete "),
            t("button", {
              type: "button",
...
const A = /* @__PURE__ */ S(z, [["__scopeId", "data-v-c11d9962"]]), K = /* @__PURE__ */ y({
  __name: "List",
  setup(d) {
    const o = w(), { entries: n } = V(o);
    return (r, v) => (a(), c(h, null, [
      t("h4", null, [
        l("List "),
        p(r.$slots, "object-type"),
        l("s")
      ]),
      (a(!0), c(h, null, P(B(n), (u) => (a(), c("div", {
        key: u.id.toString()
      }, [
