...
import { _ as h, u as k } from "./library-exports.46026ce1.js";
...
const O = /* @__PURE__ */ h(M, [["__scopeId", "data-v-25885900"]]), q = (o) => (E("data-v-8feeb7f8"), o = o(), I(), o), z = { class: "row entryRow" }, A = /* @__PURE__ */ q(() => /* @__PURE__ */ t("a", {
  href: "#",
  class: "col-2"
  ...
  setup(o) {
    const e = o, n = w(!1), i = k(), u = () => n.value = !n.value, c = (y) => i.deleteObject(y), $ = "/read/" + e.entry.id, S = "/update/" + e.entry.id;
        ...
        n.value ? (r(), f(O, {
          ...
          footer: l(() => [
            t("button", {
              type: "button",
              class: "ok-btn",
              onClick: s[2] || (s[2] = (_) => c("https://localhost:5020/api/items/" + e.entry.id)),
...
const H = /* @__PURE__ */ h(G, [["__scopeId", "data-v-8feeb7f8"]]), W = /* @__PURE__ */ m({
  __name: "List",
  setup(o) {
